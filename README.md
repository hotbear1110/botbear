>[!WARNING]
>I'm moving my repositories to my [Codeberg account](https://codeberg.org/hotbear1110). This repository has moved over to https://codeberg.org/hotbear1110/botbear

# botbear
Dank bot that does stuff, idk
Link to my commands: https://hotbear.org/
If you just want this bot in your channel just write "bb join" in #botbear1110 or #HotBear1110 :)
