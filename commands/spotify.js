	...
	execute: async (channel, user, input, perm, aliascommand) => {
		try {
			...
			if (err.message.startsWith('RequestError: Unexpected token U in JSON at position 0')) {
				return 'FeelsDankMan I\'m still not verified by spotify, so I can only add spotify "testers" manually via the dev dashboard. If you want to become a "tester" message @hotbear1110. You will need to provide your Email to get added.';
			}
